...
const Hackathon = () => {
  ...
  return (
    <div className="my-64">
      <h2 className="font-bold text-8xl mb-32 w-full text-center md:text-6xl xs:text-4xl md:mb-16">Hackathon</h2>
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="IBM Watsonx Hackathon"
            time="2023"
            place="IBM"
            info="Winner of IBM Watsonx Hackathon."
          />
        </ul>
      </div>
    </div>
