  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        {/* <CustomLink className="mx-4" href="https://blogs.sknanalytics.com/" target={"_blank"} title="Articles" /> */}
      ...
      >
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/sankalp-kumar-nayak-s001/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        {/* <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="https://blogs.sknanalytics.com/" title="Articles" /> */}
